...
// based from tflite_flutter example app of live object detection.
...
/// All the command codes that can be sent and received between [Detector] and [_DetectorServer].
...
class Detector {
  ...
  // Similarly, StreamControllers are stored in a queue so they can be handeled asynchronously and serially.
